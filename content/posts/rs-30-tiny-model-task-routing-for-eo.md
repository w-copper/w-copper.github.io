...
source: "research/RS-30_tiny_model_task_routing_for_eo.md"
...
> 系列定位：这是一篇可独立发布的研究博客草稿，来自 `RS-30` 细分方向调研。它聚焦一个小问题，而不是泛泛讨论大方向。

## 摘要

更新时间：20260607 范围：星上或边缘端的光学/多光谱遥感任务路由。核心问题是：先用轻量 cloud mask、saliency、tiny detector 或低分辨率模型判断是否调用大模型、是否下传图像、是否触发灾害回退机制，从而节省能耗和带宽，同时控制漏检风险。 1. 方向概述 星上 AI 的早期目标通常是“把一个小模型塞进 CubeSat/边缘硬
