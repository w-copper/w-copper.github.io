...
tags: ["泛化", "OOD", "不确定性"]
source: "research/rs23_uncertainty_calibrated_large_scale_mapping.md"
...
> 系列定位：这是一篇可独立发布的研究博客草稿，来自 `RS-23` 细分方向调研。它聚焦一个小问题，而不是泛泛讨论大方向。

## 摘要

更新时间：20260607 摘要 大范围遥感制图的核心问题不是只把 mIoU、F1 或 RMSE 做高，而是让地图产品知道“哪里可靠、哪里不可靠、为什么不可靠”。20242026 的相关工作正在把 conformal prediction、spatial calibration、Bayesian/ensemble uncertainty、neural pro
