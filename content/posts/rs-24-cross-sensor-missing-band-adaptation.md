---
title: "RS-24 Cross-Sensor Missing-Band Adaptation"
date: 2026-06-07
series: ["2024-2026 遥感 AI 细分研究方向"]
tags: ["泛化", "OOD", "不确定性"]
source: "research/rs24_cross_sensor_missing_band_adaptation.md"
...
> 系列定位：这是一篇可独立发布的研究博客草稿，来自 `RS-24` 细分方向调研。它聚焦一个小问题，而不是泛泛讨论大方向。

## 摘要

更新时间：20260607 任务范围：多光谱/高光谱模型在跨传感器时的 band 缺失、band 数量不同、中心波长/带宽不同、spectral response function (SRF) 不同，以及空间分辨率耦合问题。默认排除 SAR 主线；若论文包含 SAR，只取对光学/多光谱/高光谱适配有用的机制。 1. 核心判断 跨传感器 missingband
...
更新时间：2026-06-07  
任务范围：多光谱/高光谱模型在跨传感器时的 band 缺失、band 数量不同、中心波长/带宽不同、spectral response function (SRF) 不同，以及空间分辨率耦合问题。默认排除 SAR 主线；若论文包含 SAR，只取对光学/多光谱/高光谱适配有用的机制。
